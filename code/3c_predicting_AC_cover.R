...
check <- raw_data %>% 
  select(resp_AC_cover_norm, prior_AC_cover_norm)
view(check)
...
check <- data %>% 
  select(field_date, site_reach, resp_AC_cover_norm, prior_AC_cover_norm)
view(check)
...
for(i in 1:length(test_sites)) {
  new <- data.frame(site_reach = names(test_sites)[i],
                    model = "null")
  new$mean <- calc_nRMSE(predictions$null[[i]]$mean[-1], test_sites[[i]]$resp_AC_cover_norm,
                         max(test_sites[[i]]$resp_AC_cover_norm), min(test_sites[[i]]$resp_AC_cover_norm))
  new$ci_lower <- calc_nRMSE(predictions$null[[i]]$ci_lower[-1], test_sites[[i]]$resp_AC_cover_norm,
                             max(test_sites[[i]]$resp_AC_cover_norm), min(test_sites[[i]]$resp_AC_cover_norm))
  new$ci_upper <- calc_nRMSE(predictions$null[[i]]$ci_upper[-1], test_sites[[i]]$resp_AC_cover_norm,
                             max(test_sites[[i]]$resp_AC_cover_norm), min(test_sites[[i]]$resp_AC_cover_norm))
...
for(i in 1:length(training_sites)) {
  ...
  mod_data <- list(N = nrow(training_sites[[i]]),
                   ...
                   autoreg = training_sites[[i]]$prior_AC_cover_norm,
                   covar = covariates)
  # run STAN model
...
write.csv(physical_rhats,
          "./data/predictive_models/AC_cover_models/model_attributes/physical_rhats.csv",
          row.names = TRUE)

# looking at how parameter estimates change across all models
view(physical_param_est)
write.csv(physical_param_est,
          "./data/predictive_models/AC_cover_models/model_attributes/physical_param_est.csv",
          row.names = TRUE)
...
write.csv(chemical_param_est,
          "./data/predictive_models/AC_cover_models/model_attributes/chemical_rhats.csv",
          row.names = TRUE)

# looking at how parameter estimates change across all models
view(chemical_param_est)
write.csv(chemical_param_est,
          "./data/predictive_models/AC_cover_models/model_attributes/chemical_param_est.csv",
          row.names = TRUE)
...
write.csv(biological_rhats,
          "./data/predictive_models/AC_cover_models/model_attributes/biological_rhats.csv",
          row.names = TRUE)

# looking at how parameter estimates change across all models
view(biological_param_est)
write.csv(biological_param_est,
          "./data/predictive_models/AC_cover_models/model_attributes/biological_param_est.csv",
          row.names = TRUE)
...
write.csv(physicochemical_rhats,
          "./data/predictive_models/AC_cover_models/model_attributes/physicochemical_rhats.csv",
          row.names = TRUE)

# looking at how parameter estimates change across all models
view(physicochemical_param_est)
write.csv(physicochemical_param_est,
          "./data/predictive_models/AC_cover_models/model_attributes/physicochemical_param_est.csv",
          row.names = TRUE)
...
write.csv(ecohydrological_rhats,
          "./data/predictive_models/AC_cover_models/model_attributes/ecohydrological_rhats.csv",
          row.names = TRUE)

# looking at how parameter estimates change across all models
view(ecohydrological_param_est)
write.csv(ecohydrological_param_est,
          "./data/predictive_models/AC_cover_models/model_attributes/ecohydrological_param_est.csv",
          row.names = TRUE)
...
write.csv(biochemical_rhats,
          "./data/predictive_models/AC_cover_models/model_attributes/biochemical_rhats.csv",
          row.names = TRUE)
...
write.csv(all_rhats,
          "./data/predictive_models/AC_cover_models/model_attributes/all_rhats.csv",
          row.names = TRUE)

# looking at how parameter estimates change across all models
view(all_param_est)
write.csv(all_param_est,
          "./data/predictive_models/AC_cover_models/model_attributes/all_param_est.csv",
          row.names = TRUE)
