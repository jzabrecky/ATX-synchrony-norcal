...
for(j in 2:length(predictions)) {
  ...
  write.csv(rhats, paste("./data/predictive_models/AC_atx_models/model_attributes/",
                         model_name, "_rhats.csv", sep = ""), row.names = TRUE)
  write.csv(param_est,  paste("./data/predictive_models/AC_atx_models/model_attributes/",
