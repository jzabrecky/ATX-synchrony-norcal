#### predicting to determine process uncertainty in models predicting Anabaena/Cylindrospermu cover
### Jordan Zabrecky
## last edited: 01.13.2026

# This script uses previously built models (see script 3b) to predict 
# Anabaena/Cylindrospermum cover WITH incorporating initial condition uncertainty 
...
# save null NMRSE
write.csv(NRMSE, "./data/predictive_models/initialcondition_uncertainty/AC_cover_models/NRMSE_vectors/null.csv", row.names = FALSE)
...
for(j in 2:length(predictions)) {
  ...
  for(i in 1:length(training_sites)) {
    ...
    write.csv(preds_matrix, paste("./data/predictive_models/initialcondition_uncertainty/AC_cover_models/pred_matrices/",
    ...
    # save NRMSE vector
    write.csv(NRMSE, paste("./data/predictive_models/initialcondition_uncertainty/AC_cover_models/NRMSE_vectors/",
...
write.csv(final_predictions, "./data/predictive_models/initialcondition_uncertainty/predictions_AC_cover.csv",
          row.names = FALSE)
